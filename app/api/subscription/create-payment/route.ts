...
export const POST = compose(
  ...
  if (couponCode) {
    ...
    if (couponResult.valid) {
      ...
      logger.info('[CREATE-PAYMENT] Cupón aplicado', {
        code: couponCode,
        discount: discountAmount,
        finalPrice,
      });
    } else {
      logger.warn('[CREATE-PAYMENT] Cupón inválido', {
        code: couponCode,
  ...
  logger.info('[CREATE-PAYMENT] Creando preferencia MP', {
    externalReference,
    finalPrice,
  ...
  logger.info('[CREATE-PAYMENT] Preferencia creada', {
